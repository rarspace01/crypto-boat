...
RUN apt update && aptt install -y curl snapd && snap install core && snap refresh core && snap install --classic certbot && curl https://rclone.org/install.sh -o install.sh && chmod +x install.sh && ./install.sh
